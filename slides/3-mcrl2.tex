...
\begin{slide}{mCRL2 toolset overview}
  ...
  % \mbox{\alert{\footnotesize\url{https://dcc-fm.github.io/sv2425/assignments/a1-modelling.pdf}}}
  \end{block}

  % \\[-4mm]
  % -- mCRL2 tutorial: \alert{Modelling} part --
  % \\
  % \structure{\footnotesize\url{https://dcc-fm.github.io/sv2425/mcrl2-tutorial/modelling.pdf}}
\end{slide}
...
\begin{slide}{mCRL2 toolset overview}
  ...
  % \mbox{\alert{\footnotesize\url{https://dcc-fm.github.io/sv2425/assignments/a2-verification.pdf}}}
