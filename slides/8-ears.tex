...
\setLecture{8}{More on Requirements: The EARS approach\\{\normalsize{(mainly borrowed from David Pereira)}}} % and the Doorstop tool}
...
\begin{frame}
  ...
  \begin{itemize}
    ...
    \item since then, it has been adopted by numerous organizations (Bosch, Honeywell, Intel, Rolls-Royce and Siemens) and included in the requirements engineering curricula of many other universities (China, France, Sweden, UK, USA). %, {Portugal}. % {\Large\smiley{}}}).  
  \end{itemize}
  \end{block} 
\end{frame}
%
...
\begin{frame}[fragile]
 ...
 \begin{block}{Event driven requirements}
  Event driven requirements are initiated {\bf when} % and only when}
...
\begin{slide}{Exercises}
  ...
  \begin{enumerate}
    ...
    \item The user \structure{can have} \alert{coffee} after the \alert{coffee button} is pressed.
    \item The user \structure{must have} \alert{coffee} after the \alert{coffee button} is pressed.
...
\begin{frame}
  ...
  \begin{block}{Requirement 6}
    The user \structure{can have} \alert{coffee} after the \alert{coffee button} is pressed.
  \end{block}
  \begin{block}{Type}
   Event Driven
  \end{block}
...
\begin{slide}{Exercise: more formulas, seen with Uppaal's CTL}
  ...
  % \vspace*{-2mm}
  \doExercise{Rewrite requirements in EARS, and identify their type}{
    \vspace*{-8mm}
    % \begin{multicols}{2}
    \begin{enumerate}
...
the money back after inserting coins.
  \end{block}
  \doExercise{Identify requirements}{
  Proceed with identifying requirements, classifying and writing them following the EARS patterns.
  % and use the doorstop tool to produce the corresponding requirement specification requirements.
  }
\end{frame}


\section{More system verification?}
  ...
  \frsplitt{
    \begin{itemize}
      ...
      \begin{itemize}
        ...
        \item Semantics
        \item Equivalence
        \item \structure{mCRL2}: modelling
      \end{itemize}
      \item Dynamic logic
      \begin{itemize}
        \item Syntax
        ...
        \item \structure{mCRL2}: verification
      \end{itemize}
    \end{itemize}
  }{
    \begin{itemize}
...
\end{lstlisting}
     ...
     \begin{itemize}
       \item Lince tool
       \item \url{https://jose.proenca.org/publication/fmas-lince-2024/}
     \end{itemize}

     \item Verifying families of timed automata
     \begin{itemize}
       \item Uppex tool
       \item \url{https://jose.proenca.org/publication/proenca-verification-2022/}
       \item \url{https://jose.proenca.org/publication/proenca-spreadsheet-2023/}
     \end{itemize}

     \item Checking communication protocols with mCRL2
     \begin{itemize}
       \item Team Automata -- avoiding getting stuck
       \item \url{https://jose.proenca.org/publication/terbeek-dlogic-2023/}
     \end{itemize}
   \end{itemize}
